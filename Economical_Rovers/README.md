...
The Economical Rovers section of the Predictive Plant Phenomics Graduate Student Phenotyping Sensors workshop, sponsored by Corteva Agriscience, at Phenome2020 demonstrates how rovers have been developed by students in various disciplines using low-cost and publicly available materials. We have assembled the necessary code and hardware to create three rovers, each described below.
...
* Overview of the rovers:
    ...
    + Rover 2 is more complex than Rover 1, because this rover has a constructed body and executes an uploaded pre-planned path while under battery power. 
    + Rover 3 is the most complex rover that we have constructed; it includes wireless controls, prefabricated body, and upgraded hardware.
...
The required hardware, software, and code can be found in the sections below:
...
In this section you can find information about the remote controlled rover, this is a more advanced build and requires more materials. Rover 3 is also the least economical of the options presented here.
